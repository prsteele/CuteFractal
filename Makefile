...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Jan 12 11:58:33 2013
...
SOURCES       = evaluate.cc \
		...
		julia.cc \
		main_window.cc \
		fractal_manager.cc moc_fractal_view.cpp \
		moc_main_window.cpp
OBJECTS       = evaluate.o \
		iterated_fractal.o \
		main.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QTFractal1.0.0/ && $(COPY_FILE) --parents evaluate.hh iterated_fractal.hh mandelbrot.hh palette.hh result.hh viewport.hh fractal.hh fractal_view.hh julia.hh main_window.hh fractal_manager.hh .tmp/QTFractal1.0.0/ && $(COPY_FILE) --parents evaluate.cc iterated_fractal.cc main.cc mandelbrot.cc palette.cc result.cc viewport.cc fractal.cc fractal_view.cc julia.cc main_window.cc fractal_manager.cc .tmp/QTFractal1.0.0/ && (cd `dirname .tmp/QTFractal1.0.0` && $(TAR) QTFractal1.0.0.tar QTFractal1.0.0 && $(COMPRESS) QTFractal1.0.0.tar) && $(MOVE) `dirname .tmp/QTFractal1.0.0`/QTFractal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QTFractal1.0.0
...
moc_main_window.cpp: fractal_view.hh \
		fractal.hh \
		viewport.hh \
		fractal_manager.hh \
		main_window.hh
