...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Jan 11 18:31:37 2013
...
SOURCES       = evaluate.cc \
		...
		viewport.cc \
		fractal.cc \
		fractal_view.cc moc_fractal_view.cpp
OBJECTS       = evaluate.o \
		iterated_fractal.o \
		main.o \
		mandelbrot.o \
