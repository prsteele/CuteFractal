...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Jan 11 01:22:41 2013
...
compiler_moc_header_make_all: moc_render.cpp moc_window.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_render.cpp moc_window.cpp
moc_render.cpp: render.hh
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) render.hh -o moc_render.cpp

moc_window.cpp: render.hh \
		window.hh
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) window.hh -o moc_window.cpp
