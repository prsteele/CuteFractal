...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Jan 13 17:24:11 2013
...
SOURCES       = iterated_fractal.cc \
		...
		linear_interpolator.cc moc_qfractal_view.cpp \
		moc_qfractal_window.cpp
OBJECTS       = iterated_fractal.o \
		main.o \
		mandelbrot.o \
		palette.o \
		result.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QTFractal1.0.0/ && $(COPY_FILE) --parents iterated_fractal.hh mandelbrot.hh palette.hh result.hh viewport.hh fractal.hh qfractal_view.hh julia.hh qfractal_window.hh fractal_manager.hh palette_manager.hh evaluator_manager.hh bw_palette.hh greyscale_palette.hh evaluator.hh linear_interpolator.hh .tmp/QTFractal1.0.0/ && $(COPY_FILE) --parents iterated_fractal.cc main.cc mandelbrot.cc palette.cc result.cc viewport.cc fractal.cc qfractal_view.cc julia.cc qfractal_window.cc fractal_manager.cc palette_manager.cc evaluator_manager.cc bw_palette.cc greyscale_palette.cc linear_interpolator.cc .tmp/QTFractal1.0.0/ && (cd `dirname .tmp/QTFractal1.0.0` && $(TAR) QTFractal1.0.0.tar QTFractal1.0.0 && $(COMPRESS) QTFractal1.0.0.tar) && $(MOVE) `dirname .tmp/QTFractal1.0.0`/QTFractal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QTFractal1.0.0
...
qfractal_view.o: qfractal_view.cc qfractal_view.hh \
		fractal.hh \
		viewport.hh
...
palette_manager.o: palette_manager.cc palette_manager.hh \
		bw_palette.hh \
		palette.hh \
		greyscale_palette.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o palette_manager.o palette_manager.cc

evaluator_manager.o: evaluator_manager.cc evaluator_manager.hh \
		evaluator.hh \
		result.hh \
		linear_interpolator.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o evaluator_manager.o evaluator_manager.cc

bw_palette.o: bw_palette.cc bw_palette.hh \
		palette.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bw_palette.o bw_palette.cc

greyscale_palette.o: greyscale_palette.cc greyscale_palette.hh \
		palette.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o greyscale_palette.o greyscale_palette.cc

linear_interpolator.o: linear_interpolator.cc linear_interpolator.hh \
		evaluator.hh \
		result.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o linear_interpolator.o linear_interpolator.cc
