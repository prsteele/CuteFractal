...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Jan 12 12:21:01 2013
...
SOURCES       = evaluate.cc \
		...
		fractal_manager.cc moc_fractal_view_widget.cpp \
		moc_main_window_widget.cpp
OBJECTS       = evaluate.o \
		iterated_fractal.o \
		main.o \
		mandelbrot.o \
		...
		viewport.o \
		fractal.o \
		fractal_view_widget.o \
		julia.o \
		main_window_widget.o \
		fractal_manager.o \
		moc_fractal_view_widget.o \
		moc_main_window_widget.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QTFractal1.0.0/ && $(COPY_FILE) --parents evaluate.hh iterated_fractal.hh mandelbrot.hh palette.hh result.hh viewport.hh fractal.hh fractal_view_widget.hh julia.hh main_window_widget.hh fractal_manager.hh .tmp/QTFractal1.0.0/ && $(COPY_FILE) --parents evaluate.cc iterated_fractal.cc main.cc mandelbrot.cc palette.cc result.cc viewport.cc fractal.cc fractal_view_widget.cc julia.cc main_window_widget.cc fractal_manager.cc .tmp/QTFractal1.0.0/ && (cd `dirname .tmp/QTFractal1.0.0` && $(TAR) QTFractal1.0.0.tar QTFractal1.0.0 && $(COMPRESS) QTFractal1.0.0.tar) && $(MOVE) `dirname .tmp/QTFractal1.0.0`/QTFractal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QTFractal1.0.0
...
compiler_moc_header_make_all: moc_fractal_view_widget.cpp moc_main_window_widget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_fractal_view_widget.cpp moc_main_window_widget.cpp
moc_fractal_view_widget.cpp: fractal.hh \
		viewport.hh \
		fractal_view_widget.hh
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) fractal_view_widget.hh -o moc_fractal_view_widget.cpp

moc_main_window_widget.cpp: fractal_manager.hh \
		fractal.hh \
		viewport.hh \
		main_window_widget.hh
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) main_window_widget.hh -o moc_main_window_widget.cpp
...
fractal_view_widget.o: fractal_view_widget.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fractal_view_widget.o fractal_view_widget.cc
...
main_window_widget.o: main_window_widget.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main_window_widget.o main_window_widget.cc
...
moc_fractal_view_widget.o: moc_fractal_view_widget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_fractal_view_widget.o moc_fractal_view_widget.cpp

moc_main_window_widget.o: moc_main_window_widget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_main_window_widget.o moc_main_window_widget.cpp
